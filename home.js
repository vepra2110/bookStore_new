...
function AddBook(catagory, Container) {
  books.forEach(book => {
    if (book.category == catagory) {
      ...
      <div class="overlay">
        <button id="wish${i}" onclick="addToWishlist(${book.id}); toggleWishlist(this);" class="bookmark"><svg xmlns="http://www.w3.org/2000/svg" height="18px"
                          viewBox="0 -960 960 960" width="24px" fill="#ffcocb">
                          <path
